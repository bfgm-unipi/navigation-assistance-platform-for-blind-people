 ...
 */
package com.google.ar.core.vibaplatform.java.common.helpers;
...
public class DepthSettings {
    ...
    public boolean drawCameraBackgroundEnabled() { return  drawCameraBackground; }

    public void setDrawCameraBackgroundEnabled(boolean drawCameraBackgroundEnabled) {
        this.drawCameraBackground = drawCameraBackgroundEnabled;
    }

    public boolean drawUserCollisionStateEnabled() { return drawUserCollisionState; }
